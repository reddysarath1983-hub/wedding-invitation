...
import { MapPin, Calendar, Clock, Heart, Users, Sparkles } from "lucide-react";
      ...
      <div className="max-w-2xl mx-auto bg-[#fdfbf7] min-h-screen relative overflow-hidden border-x border-[#c59b27]/30 shadow-2xl">
        ...
        <section className="px-6 py-4 text-center">
          ...
          <div className="space-y-1">
            <h1 className="text-3xl sm:text-4xl font-bold font-telugu text-[#58121a] tracking-tight">
              {groom_name}
            </h1>
        ...
        {events.length > 0 && (
          <section className="px-6 py-10">
            <div className="text-center mb-8">
              ...
              <p className="font-luxury italic text-xs text-[#8b6508] mt-0.5">
                Ceremonial Schedule
              </p>
            </div>
              ...
              {events.map((ev, idx) => (
                <div key={ev.id || idx} className="relative group">
                  ...
                  <div className="pb-2">
                    ...
                    {ev.description && (
                      <p className="font-telugu text-xs text-[#8b6508]/80 mt-1.5 italic">
                        {ev.description}
                      </p>
                    )}
                  </div>
        ...
        <section className="px-6 py-8 mx-6 my-4 rounded-3xl bg-gradient-to-b from-white to-[#fbf7ef] border border-[#c59b27]/30 text-center shadow-xs">
          ...
          <span className="text-[11px] font-luxury uppercase tracking-widest text-[#8b6508] block mb-1">
            LOCATION & VENUE
          </span>
          ...
          {google_maps_url && (
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#58121a] hover:bg-[#7c1a29] text-[#fdfbf7] font-telugu text-xs font-semibold tracking-wider transition-colors shadow-md border border-[#c59b27]/40"
            >
        ...
        {/* 8. EDITORIAL PHOTO ALBUM WITH MOVABLE IMAGES */}
